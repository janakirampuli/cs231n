...
class CaptioningTransformer(nn.Module):
    ...
    def __init__(self, word_to_idx, input_dim, wordvec_dim, num_heads=4,
        ...
        # Pass max_len by keyword to avoid treating it as dropout probability
        self.positional_encoding = PositionalEncoding(wordvec_dim, dropout=0.1, max_len=max_length)
    ...
    def forward(self, features, captions):
        ...
        decoder_output = self.transformer(tgt=captions_embed, memory=features_proj, tgt_mask=tgt_mask)
