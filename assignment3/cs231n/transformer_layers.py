...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0.1):
        ...
        # implementation).
        # Use the original initialization order to match expected test weights
    ...
    def forward(self, query, key, value, attn_mask=None):
        ...
        if attn_mask is not None:
            ...
            # Use -inf to match the reference outputs for the unit tests
...
class PatchEmbedding(nn.Module):
    ...
    def forward(self, x):
        ...
        # (N, (H/P * W/P), (C * P * P)) -> (N, num_patches, pacth_dim)
        x = x.view(N, self.num_patches, self.patch_dim)
